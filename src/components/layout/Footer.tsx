  ...
  return (
    <footer className="relative bg-transparent border-t border-glass-border pt-32 pb-8 overflow-hidden z-20" style={{ paddingBottom: 'calc(2rem + env(safe-area-inset-bottom, 0px))' }}>
      ...
      <div className="max-w-[1280px] mx-auto px-[5vw] relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-16 lg:gap-8 mb-20">
          ...
          <div className="flex flex-col lg:col-span-4">
            <Link href="/" className="flex items-center gap-3 mb-6">
              <img src="/logo.png" alt="Khemji Wire Logo" className="h-16 md:h-20 w-auto object-contain" />
            </Link>
            <div className="font-mono text-[10px] sm:text-xs text-steel/70 tracking-[0.2em] uppercase mb-8 leading-relaxed">
              <SplitText text="Precision in Every Strand. Strength in Every Connection." delayOffset={0.1} />
            </div>
            <div className="flex items-center gap-4">
              <MagneticButton>
                <a href="https://linkedin.com" target="_blank" rel="noreferrer" aria-label="Follow us on LinkedIn" className="w-12 h-12 rounded-full border border-glass-border flex items-center justify-center text-steel hover:text-amber hover:border-amber transition-all duration-300 relative overflow-hidden group">
                  <div className="absolute inset-0 bg-amber rounded-full translate-y-full group-hover:translate-y-0 transition-transform duration-300" />
                  <svg className="w-5 h-5 relative z-10 group-hover:text-obsidian transition-colors" fill="currentColor" viewBox="0 0 24 24"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/></svg>
                </a>
              </MagneticButton>
              <MagneticButton>
                <a href="https://wa.me/919829277869" target="_blank" rel="noreferrer" aria-label="Chat on WhatsApp" className="w-12 h-12 rounded-full border border-glass-border flex items-center justify-center text-steel hover:text-amber hover:border-amber transition-all duration-300 relative overflow-hidden group">
                   <div className="absolute inset-0 bg-amber rounded-full translate-y-full group-hover:translate-y-0 transition-transform duration-300" />
          ...
          <div className="flex flex-col lg:col-span-3">
            ...
            <div className="flex items-center gap-3">
               <span className="px-3 py-1 rounded-full border border-glass-border font-bebas text-lg text-cream bg-white/5">IS 280</span>
               <span className="px-3 py-1 rounded-full border border-glass-border font-bebas text-lg text-cream bg-white/5">IS 3975</span>
               <span className="px-3 py-1 rounded-full border border-glass-border font-bebas text-lg text-cream bg-white/5">UDYAM</span>
            </div>
          </div>
        ...
        {/* Bottom Strip */}
        <div className="pt-8 border-t border-glass-border flex flex-col md:flex-row items-center justify-between gap-6 font-mono text-[10px] uppercase tracking-widest text-steel/60 text-center md:text-left">
