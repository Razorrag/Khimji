...
export function Footer() {
  return (
    <footer className="relative bg-transparent border-t border-glass-border pt-32 pb-8 overflow-hidden z-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-16 lg:gap-8 mb-20">
          ...
          <div className="flex flex-col lg:col-span-4">
            ...
            <div className="flex items-center gap-4">
              <MagneticButton>
                <a href="https://linkedin.com" target="_blank" rel="noreferrer" className="w-12 h-12 rounded-full border border-glass-border flex items-center justify-center text-steel hover:text-amber hover:border-amber transition-colors shadow-2xl relative overflow-hidden group">
              ...
              <MagneticButton>
                <a href="https://wa.me/919829277869" target="_blank" rel="noreferrer" className="w-12 h-12 rounded-full border border-glass-border flex items-center justify-center text-steel hover:text-amber hover:border-amber transition-colors shadow-2xl relative overflow-hidden group">
                   <div className="absolute inset-0 bg-amber translate-y-full group-hover:translate-y-0 transition-transform duration-300" />
