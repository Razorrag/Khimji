        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 lg:gap-8 mb-20">
          ...
          <div className="flex flex-col">
            ...
            <div className="flex items-center gap-4">
              <MagneticButton>
                <a href="#" className="w-12 h-12 rounded-full border border-glass-border flex items-center justify-center text-steel hover:text-amber hover:border-amber transition-colors shadow-2xl relative overflow-hidden group">
