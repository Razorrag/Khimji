...
export function Footer() {
  return (
    <footer className="relative bg-transparent border-t border-glass-border pt-20 pb-8 overflow-hidden z-20" style={{ paddingBottom: 'calc(2rem + env(safe-area-inset-bottom, 0px))' }}>
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[600px] h-[200px] blur-[100px] pointer-events-none opacity-30"
      ...
      <div className="max-w-[1280px] mx-auto px-[5vw] relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8 mb-16">
          ...
          <div className="flex flex-col lg:col-span-4">
            ...
            <div className="flex items-center gap-3">
              <a href="https://linkedin.com" target="_blank" rel="noreferrer" aria-label="LinkedIn" className="w-10 h-10 rounded-full border border-white/10 flex items-center justify-center text-steel/75 hover:text-amber hover:border-amber/40 transition-all duration-300">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/></svg>
              </a>
              <a href="https://wa.me/919829277869" target="_blank" rel="noreferrer" aria-label="WhatsApp" className="w-10 h-10 rounded-full border border-white/10 flex items-center justify-center text-steel/75 hover:text-amber hover:border-amber/40 transition-all duration-300">
          ...
          <div className="flex flex-col lg:col-span-2">
            ...
            <nav className="flex flex-col gap-3">
              {[
                ...
                <Link key={link.label} href={link.href} className="font-sans text-[13px] text-steel/85 hover:text-cream transition-colors w-fit">
                  {link.label}
                </Link>
              ))}
            </nav>
          ...
          <div className="flex flex-col lg:col-span-3">
            ...
            <div className="flex flex-col gap-3 font-sans text-[13px] text-steel/75 leading-relaxed">
            ...
            <div className="flex flex-wrap items-center gap-2 mt-5">
              <span className="px-2.5 py-1 rounded border border-white/20 font-mono text-[9px] text-steel/70 uppercase tracking-wider">IS 280</span>
              <span className="px-2.5 py-1 rounded border border-white/20 font-mono text-[9px] text-steel/70 uppercase tracking-wider">IS 3975</span>
              <span className="px-2.5 py-1 rounded border border-white/20 font-mono text-[9px] text-steel/70 uppercase tracking-wider">UDYAM</span>
            </div>
          </div>
        ...
        <div className="pt-6 border-t border-white/5 flex flex-col md:flex-row items-center justify-between gap-4">
          <span className="font-mono text-[10px] text-steel/60 tracking-wider">
            \u00a9 {new Date().getFullYear()} Khemji Wire & Wire Pvt. Ltd.
          </span>
          <div className="flex items-center gap-4 font-mono text-[10px] text-steel/60 tracking-wider">
