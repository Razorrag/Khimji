        ...
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-8 mb-16">
          ...
          >
            ...
            <div className="flex items-center gap-3">
              <a href="https://linkedin.com" target="_blank" rel="noreferrer" aria-label="LinkedIn" className="w-10 h-10 rounded-full border border-white/10 flex items-center justify-center text-cream/60 hover:text-amber hover:border-amber/40 transition-all duration-300">
