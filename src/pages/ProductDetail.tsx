...
export function ProductDetail() {
  ...
  const product = slug ? PRODUCT_DB[slug] : null;
      ...
      <PageTransition>
        <div className="min-h-screen flex items-center justify-center pt-20">
          <div className="text-center">
             ...
             <Link to="/products" className="text-amber hover:text-cream transition-colors font-mono uppercase tracking-widest text-xs">
               ← Back to Catalogue
             </Link>
          </div>
        </div>
  ...
  return (
    <PageTransition>
      <SEOHead 
        title={`${product.name} | Khemji Wire`} 
        description={product.desc}
      />
      
      <div className="pt-32 pb-20 max-w-[1280px] mx-auto px-[5vw]">
        
        <Link to="/products" className="inline-flex items-center gap-2 font-mono text-[10px] uppercase tracking-widest text-steel hover:text-amber transition-colors mb-12">
          ...
          <div className="flex flex-col justify-start pt-4">
            ...
            >
              <div className="glass-panel p-8 rounded-2xl border border-glass-border flex flex-col sm:flex-row items-center justify-between gap-6">
                ...
                <Link to="/contact" className="inline-flex items-center justify-center px-8 py-4 bg-amber text-obsidian font-mono text-xs tracking-widest uppercase font-bold rounded-full hover:bg-cream transition-colors whitespace-nowrap">
                  Request Quote
                </Link>
              </div>
            </motion.div>
